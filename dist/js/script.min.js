...
window.onload = function () {
  ...
  var laoder = document.querySelector('.loader-container');
  ...
  headerLogo.addEventListener('click', function () {
    var logoInPhoto = document.querySelector('.photo-board-dasboard .logo');
    var displayLogoInPhoto = window.getComputedStyle(logoInPhoto).getPropertyValue('display');
